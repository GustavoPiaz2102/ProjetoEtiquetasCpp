...
/////////////////
	...
	if (ImGui::Button("Sensor Sinc", ImVec2(TAMANHO_BOTAO_LARG / 2, TAMANHO_BOTAO_ALT / 5))) {
		selected_option = 5;
	}
	ImGui::PopStyleColor(3);
	}
	...
	// Mantendo o exato mesmo tamanho:
	if (ImGui::Button("Sensor N Sinc", ImVec2(TAMANHO_BOTAO_LARG / 2, TAMANHO_BOTAO_ALT / 5))) {
		selected_option = 5; 
	}
	ImGui::PopStyleColor(3);
	}
